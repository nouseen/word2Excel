...
public class DateUtil {
    ...
    public static final String DATETIME_ForFileName = "yyyy-MM-dd-HH-mm-ss";
    ...
    private static DateFormat dateTimeForFileName = null;
    ...
    static {
        ...
        dateTimeForFileName = new SimpleDateFormat(DATETIME_ForFileName);
    }
    ...
    public static String getDateTimeForFileName(Date date) {
        return dateTimeForFileName.format(date);
    }
